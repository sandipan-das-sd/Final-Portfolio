...
const projects = [
  ...
  { title: "Gyanoda", type: "Learning platform", tech: ["React", "Node.js", "Mobile", "EdTech"], text: "A digital learning ecosystem designed to help students discover courses, practise effectively and make clear progress across web and mobile experiences.", href: "https://www.gyanoda.com", image: "/work/learning-platform.png" },
